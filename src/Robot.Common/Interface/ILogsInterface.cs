...
namespace Robot.Common.Interface
{
    ...
    {
        void Debug(Exception ex = null, string logs = "", EnumLogLevel logLevel = EnumLogLevel.Debug, [CallerMemberName] string memberName = "", [CallerLineNumber] int lineNumber = 0, [CallerFilePath] string filePath = "");
