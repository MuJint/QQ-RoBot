...
namespace Robot.Common.Interface
{
    ...
    public interface ILogsInterface
    {
        ...
        void Info(string caption, string logs, EnumLogLevel logLevel = EnumLogLevel.Info, [CallerMemberName] string memberName = "", [CallerLineNumber] int lineNumber = 0, [CallerFilePath] string filePath = "");
        void Info(Exception ex, string logs, EnumLogLevel logLevel = EnumLogLevel.Info, [CallerMemberName] string memberName = "", [CallerLineNumber] int lineNumber = 0, [CallerFilePath] string filePath = ""); void Warn(Exception ex, string logs, EnumLogLevel logLevel = EnumLogLevel.Warn, [CallerMemberName] string memberName = "", [CallerLineNumber] int lineNumber = 0, [CallerFilePath] string filePath = "");
